...
public class ShadowJar extends Jar implements ShadowSpec {
    ...
    private List<String> localExcludes;
    ...
    public ShadowJar() {
        ...
        localExcludes = new ArrayList<String>();
    }
    ...
    protected CopyAction createCopyAction() {
        ...
        return new ShadowCopyAction(getArchivePath(), getInternalCompressor(), documentationRegistry,
                transformers, relocators, getRootPatternSet(), shadowStats, localExcludes);
    }
    ...
    /**
     * Excludes a package / clazz from getting touched by the relocation task
     *
     * @param exclude the package / clazz to exlcude
     * @return this
     */
    public ShadowJar relocateExclude(String exclude) {
        localExcludes.add(exclude);
        return this;
    }
